...
This document describes steps that need to be done to troubleshoot monitoring problems when using [Grafana/Prometheus](https://monitoring.docs.scylladb.com/stable/reference/monitoring-apis.md) monitoring tool.
...
See the [monitoring](https://monitoring.docs.scylladb.com/stable/install/monitoring-stack.md#docker-post-installation) Docker post-installation section.
...
More on start-all.sh [options](https://monitoring.docs.scylladb.com/stable/install/monitoring-stack.md).
...
If you are using a standalone Prometheus server, make sure to copy the Prometheus configuration and recording rules as describe in [install without docker](https://monitoring.docs.scylladb.com/stable/install/monitor-without-docker.md#install-prometheus).
