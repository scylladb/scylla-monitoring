...
```sh
wget -O scylla-monitoring.tar.gz https://github.com/scylladb/scylla-monitoring/archive/refs/tags/4.16.0.tar.gz
```
...
```shell
cp -p /home/centos/scylla-monitoring-4.16.0/prometheus/rule_config.yml alertmanager-0.26.0.linux-amd64/alertmanager.yml
```
...
```shell
cp scylla-monitoring-4.16.0/prometheus/prom_rules/*.yml /etc/prometheus/prom_rules/
cp scylla-monitoring-4.16.0/prometheus/prometheus.yml.template /etc/prometheus/prometheus.yml
```
