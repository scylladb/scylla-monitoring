...
This document describes the setup of Scylla Monitoring Stack, based on [Prometheus API](https://monitoring.docs.scylladb.com/branch-4.16/reference/monitoring-apis.md#api-prometheus).
...
```sh
wget https://github.com/scylladb/scylla-monitoring/archive/4.16.0-rc0.tar.gz
tar -xvf 4.16.0-rc0.tar.gz
...
See [The start-all.sh Command](https://monitoring.docs.scylladb.com/branch-4.16/install/start-all.md) for details.
