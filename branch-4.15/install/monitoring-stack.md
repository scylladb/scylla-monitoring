...
This document describes the setup of Scylla Monitoring Stack, based on [Prometheus API](https://monitoring.docs.scylladb.com/branch-4.15/reference/monitoring-apis.md#api-prometheus).
...
```sh
wget https://github.com/scylladb/scylla-monitoring/archive/4.15.3-rc1.tar.gz
tar -xvf 4.15.3-rc1.tar.gz
