...
For more information on monitoring Scylla with Prometheus see [Scylla Monitoring Stack](https://monitoring.docs.scylladb.com/stable/install/monitoring-stack.md).
