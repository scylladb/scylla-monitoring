...
#### NOTE
Scylla Cloud users, Check the cloud users [specific guide](https://monitoring.docs.scylladb.com/stable/procedures/datadog/cloud-integration.md).
...
Download the configuration file [`conf.yaml`](https://monitoring.docs.scylladb.com/stable/procedures/datadog/conf.yaml) and replace the ip address of the Prometheus server.
...
Download the rules configuration file [`datadog.rules.yml`](https://monitoring.docs.scylladb.com/stable/procedures/datadog/datadog.rules.yml) if you need per-shard metrics, download [`datadog.rules-with-shards.yml`](https://monitoring.docs.scylladb.com/stable/procedures/datadog/datadog.rules-with-shards.yml) and place it under prometheus/prom_rules/.
...
Download the dashboard file [`dashboard.json`](https://monitoring.docs.scylladb.com/stable/procedures/datadog/dashboard.json).
...
Alerts in Datadog called Monitor. Download the monitor file [`monitor.json`](https://monitoring.docs.scylladb.com/stable/procedures/datadog/monitor.json). Go to the Monitor section in datadog and import the json.
