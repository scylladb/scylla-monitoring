...
echo "GF_SECURITY_ALLOW_EMBEDDING=$GF_SECURITY_ALLOW_EMBEDDING" >>.env
echo "GF_SECURITY_COOKIE_SECURE=$GF_SECURITY_COOKIE_SECURE" >>.env
echo "GF_SECURITY_COOKIE_SAMESITE=$GF_SECURITY_COOKIE_SAMESITE" >>.env
