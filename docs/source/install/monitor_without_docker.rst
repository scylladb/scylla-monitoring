...
.. note:: Confirm before installing, that your Grafana and Prometheus versions are supported by the Monitoring Stack version you want to install. See the `Scylla Monitoring Stack Compatibility Matrix </install/monitoring_stack/#prerequisites>`_.
