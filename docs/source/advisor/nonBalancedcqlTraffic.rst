...
-----------------------------------------
For optimal performance, data and queries should be distributed evenly across nodes and shards. If some shards are getting more traffic they would become a bottleneck for Scylla.
